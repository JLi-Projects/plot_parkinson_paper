...
plt.clabel(C,inline=True,inline_spacing=8,fmt='%i',fontsize=6)
...
plt.savefig('Figure_a_height.png', dpi=300)

plt.savefig('Figure_a_height.eps', format='eps')
plt.close()
####################################

# Plot for Figure_a_temperature.png
matrix_2=np.zeros(shape=(840,6))
for i in range(0,839):
...
plt.clabel(C,inline=True,inline_spacing=8,colors=('white','white','white','white','black','black','black','black','black','black','black','black','black','black','black','black'),fmt='%i',fontsize=6)
#plt.pcolor(X,Y,temperature.T,cmap=plt.cm.jet)
#plt.pcolor(X,Y,temperature.T,cmap=plt.cm.nipy_spectral)
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_a_temperature.png', dpi=300)

plt.savefig('Figure_a_temperature.eps', format='eps')
plt.close()
###########################################
...
plt.clabel(C,inline=True,inline_spacing=8,fmt='%.2f',fontsize=6)
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_a_o1.png', dpi=300)

plt.savefig('Figure_a_o1.eps', format='eps')
plt.close()
#############################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_a_co.png', dpi=300)

plt.savefig('Figure_a_co.eps', format='eps')
plt.close()
#############################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_a_co2.png', dpi=300)

plt.savefig('Figure_a_co2.eps', format='eps')
plt.close()
#############################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_a_o2.png', dpi=300)

plt.savefig('Figure_a_o2.eps', format='eps')
plt.close()
#############################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_a_wind.png', dpi=300)

plt.savefig('Figure_a_wind.eps', format='eps')
plt.close()
#########################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_b_height.png', dpi=300)

plt.savefig('Figure_b_height.eps', format='eps')
plt.close()
####################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_b_temperature.png', dpi=300)

plt.savefig('Figure_b_temperature.eps', format='eps')
plt.close()
###########################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_b_o1.png', dpi=300)

plt.savefig('Figure_b_o1.eps', format='eps')
plt.close()
#############################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_b_co.png', dpi=300)

plt.savefig('Figure_b_co.eps', format='eps')
plt.close()
#############################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_b_co2.png', dpi=300)

plt.savefig('Figure_b_co2.eps', format='eps')
plt.close()
#############################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_b_o2.png', dpi=300)

plt.savefig('Figure_b_o2.eps', format='eps')
plt.close()
#############################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_b_wind.png', dpi=300)

plt.savefig('Figure_b_wind.eps', format='eps')
plt.close()
#########################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_c_height.png', dpi=300)

plt.savefig('Figure_c_height.eps', format='eps')
plt.close()
####################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_c_temperature.png', dpi=300)

plt.savefig('Figure_c_temperature.eps', format='eps')
plt.close()
###########################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_c_o1.png', dpi=300)

plt.savefig('Figure_c_o1.eps', format='eps')
plt.close()
#############################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_c_co.png', dpi=300)

plt.savefig('Figure_c_co.eps', format='eps')
plt.close()
#############################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_c_co2.png', dpi=300)

plt.savefig('Figure_c_co2.eps', format='eps')
plt.close()
#############################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_c_o2.png', dpi=300)

plt.savefig('Figure_c_o2.eps', format='eps')
plt.close()
#############################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_c_wind.png', dpi=300)

plt.savefig('Figure_c_wind.eps', format='eps')
plt.close()
#########################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_d_height.png', dpi=300)

plt.savefig('Figure_d_height.eps', format='eps')
plt.close()
####################################
...
plt.clabel(C,inline=True,inline_spacing=8,colors=('white','white','white','black','black','black','black','black','black','black','black','black','black','black','black','black','white','white','white','white','white'),fmt='%i',fontsize=6)
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_d_temperature.png', dpi=300)

plt.savefig('Figure_d_temperature.eps', format='eps')
plt.close()
###########################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_d_o1.png', dpi=300)

plt.savefig('Figure_d_o1.eps', format='eps')
plt.close()
#############################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_d_co.png', dpi=300)

plt.savefig('Figure_d_co.eps', format='eps')
plt.close()
#############################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_d_co2.png', dpi=300)

plt.savefig('Figure_d_co2.eps', format='eps')
plt.close()
#############################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_d_o2.png', dpi=300)

plt.savefig('Figure_d_o2.eps', format='eps')
plt.close()
#############################################
...
plt.contourf(X,Y,wind.T,levels=cf_lv,vmin=-350,vmax=450,cmap=plt.cm.jet)
C=plt.contour(X,Y,wind.T,levels=lines_lv,linestyles='solid',vmin=-350,vmax=450,colors='black',linewidths=0.7)
plt.clabel(C,inline=True,inline_spacing=8,colors=('white','white','black','black','black','black','black','black','black','black','black','black','black','black','black','white','white'),fmt='%i',fontsize=6)
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_d_wind.png', dpi=300)

plt.savefig('Figure_d_wind.eps', format='eps')
plt.close()
