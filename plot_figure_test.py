...
temperature_log=np.zeros(shape=(74,66))
for i in range(0,66):
  for j in range(0,73):
...
plt.contourf(X,Y,temperature_log.T,100,vmin=math.log10(100),vmax=math.log10(500),cmap=plt.cm.jet)
...
plt.savefig('Figure_a_test.png', dpi=300)

plt.savefig('Figure_a_test.eps', format='eps')
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_b_test.png', dpi=300)

plt.savefig('Figure_b_test.eps', format='eps')
#########################################################################################
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_c_test.png', dpi=300)

plt.savefig('Figure_c_test.eps', format='eps')
################################################################################################
...
C=plt.contour(X,Y,temperature.T,levels=lines_lv,vmin=100,vmax=600,colors=('white','white','white','black','black','black','black','black','black','black','black','black','black','black','black','black','black','black','black','black','black','black','black','black','white','white','white','white','white','white','white'),linewidths=0.7)
plt.clabel(C,inline=True,fmt='%i',fontsize=7)
#plt.pcolor(X,Y,temperature.T,cmap=plt.cm.jet)
#plt.pcolor(X,Y,temperature.T,cmap=plt.cm.nipy_spectral)
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_d_test.png', dpi=300)

plt.savefig('Figure_d_test.eps', format='eps')
...
plt.clabel(C,inline=True,inline_spacing=8,colors=('white','white','white','black','black','black','black','black','black','black','black','black','black','black','white','white','white','white','white'),fmt='%i',fontsize=6)
#plt.pcolor(X,Y,temperature.T,cmap=plt.cm.jet)
#plt.pcolor(X,Y,temperature.T,cmap=plt.cm.nipy_spectral)
...
my_x_ticks = np.arange(0, 360, 60)
plt.xticks(my_x_ticks)
plt.savefig('Figure_d2_test.png', dpi=300)

plt.savefig('Figure_d2_test.eps', format='eps')
