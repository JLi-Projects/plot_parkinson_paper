...
a=linecache.getline(readin_file,827+32)
matrix_2[827,0:2]=a.split()
qeuv2_0p7=np.zeros(shape=(73,68))
for i in range(0,68):
  for j in range(0,73):
    qeuv2_0p7[j,i]=matrix_2[(i*73+j)//6,(i*73+j)%6]
matrix_2=np.zeros(shape=(828,6))
for i in range(0,827):
  a=linecache.getline(readin_file,i+1750)
  matrix_2[i,:]=a.split()
a=linecache.getline(readin_file,827+1750)
matrix_2[827,0:2]=a.split()
qir2_0p7=np.zeros(shape=(73,68))
for i in range(0,68):
  for j in range(0,73):
    qir2_0p7[j,i]=matrix_2[(i*73+j)//6,(i*73+j)%6]
matrix_2=np.zeros(shape=(828,6))
for i in range(0,827):
  a=linecache.getline(readin_file,i+2609)
  matrix_2[i,:]=a.split()
a=linecache.getline(readin_file,827+2609)
matrix_2[827,0:2]=a.split()
cond2_0p7=np.zeros(shape=(73,68))
for i in range(0,68):
  for j in range(0,73):
    cond2_0p7[j,i]=matrix_2[(i*73+j)//6,(i*73+j)%6]
matrix_2=np.zeros(shape=(828,6))
for i in range(0,827):
  a=linecache.getline(readin_file,i+3468)
  matrix_2[i,:]=a.split()
...
a=linecache.getline(readin_file,827+32)
matrix_2[827,0:2]=a.split()
qeuv2_1p3=np.zeros(shape=(73,68))
for i in range(0,68):
  for j in range(0,73):
    qeuv2_1p3[j,i]=matrix_2[(i*73+j)//6,(i*73+j)%6]
matrix_2=np.zeros(shape=(828,6))
for i in range(0,827):
  a=linecache.getline(readin_file,i+1750)
  matrix_2[i,:]=a.split()
a=linecache.getline(readin_file,827+1750)
matrix_2[827,0:2]=a.split()
qir2_1p3=np.zeros(shape=(73,68))
for i in range(0,68):
  for j in range(0,73):
    qir2_1p3[j,i]=matrix_2[(i*73+j)//6,(i*73+j)%6]
matrix_2=np.zeros(shape=(828,6))
for i in range(0,827):
  a=linecache.getline(readin_file,i+2609)
  matrix_2[i,:]=a.split()
a=linecache.getline(readin_file,827+2609)
matrix_2[827,0:2]=a.split()
cond2_1p3=np.zeros(shape=(73,68))
for i in range(0,68):
  for j in range(0,73):
    cond2_1p3[j,i]=matrix_2[(i*73+j)//6,(i*73+j)%6]
matrix_2=np.zeros(shape=(828,6))
for i in range(0,827):
  a=linecache.getline(readin_file,i+3468)
  matrix_2[i,:]=a.split()
...
plt.savefig('Figure_nir_VEN2.png', dpi=300)

plt.savefig('Figure_nir_VEN2.eps', format='eps')

fig=plt.figure(figsize=(10,4))
ax=fig.add_subplot(1,2,1)
plt.plot(qeuv2[0,:],new_height,linewidth=2,linestyle='-',color='green',label='EUV-UV heating standard')
plt.plot(qeuv2_0p7[0,:],new_height,linewidth=2,linestyle='--',color='red',label='EUV-UV heating X0.7')
plt.plot(qeuv2_1p3[0,:],new_height,linewidth=2,linestyle=':',color='blue',label='EUV-UV heating X1.3')
plt.legend(fontsize=7)
plt.xlabel('[K/Day]')
#plt.xlim([-100,3600])
plt.ylim([-16,16])
...
plt.savefig('Figure_euv_VEN2.png', dpi=300)

plt.savefig('Figure_euv_VEN2.eps', format='eps')

fig=plt.figure(figsize=(10,4))
ax=fig.add_subplot(1,2,1)
plt.plot(qir2[0,:],new_height,linewidth=2,linestyle='-',color='green',label='CO$_{{2}}$ 15 ${\mu}$m cooling standard')
plt.plot(qir2_0p7[0,:],new_height,linewidth=2,linestyle='--',color='red',label='CO$_{{2}}$ 15 ${\mu}$m cooling X0.7')
plt.plot(qir2_1p3[0,:],new_height,linewidth=2,linestyle=':',color='blue',label='CO$_{{2}}$ 15 ${\mu}$m cooling X1.3')
plt.legend(fontsize=7)
plt.xlabel('[K/Day]')
#plt.xlim([-100,3600])
plt.ylim([-16,16])
...
plt.savefig('Figure_qir_VEN2.png', dpi=300)

plt.savefig('Figure_qir_VEN2.eps', format='eps')

fig=plt.figure(figsize=(10,4))
ax=fig.add_subplot(1,2,1)
plt.plot(cond2[0,:],new_height,linewidth=2,linestyle='-',color='green',label='Conduction standard')
plt.plot(cond2_0p7[0,:],new_height,linewidth=2,linestyle='--',color='red',label='Conduction X0.7')
plt.plot(cond2_1p3[0,:],new_height,linewidth=2,linestyle=':',color='blue',label='Conduction X1.3')
plt.legend(fontsize=7)
plt.xlabel('[K/Day]')
#plt.xlim([-100,3600])
plt.ylim([-16,16])
...
plt.savefig('Figure_cond2_VEN2.png', dpi=300)

plt.savefig('Figure_cond2_VEN2.eps', format='eps')
...
plt.savefig('Figure_totdynm_VEN2.png', dpi=300)

plt.savefig('Figure_totdynm_VEN2.eps', format='eps')
